...
describe PathHelper do	
	...
	describe "usb vs internal path selection" do
		it "should work for public dir" do			
			...
			public_directory_path(true).should == usb_path 
		end
		...
		it "should work for unencrypted private file path" do			
			...
			private_keys_file_path('csv',false,true).should == usb_path + private_keys_file_name + $tag.to_s + '.csv'
		end
		it "should work for encrypted private file path" do			
			...
			private_keys_file_path('csv',true,true).should == usb_path + private_keys_file_name + $tag.to_s + '.csv.aes'
		end
		it "should work for password shares file path" do			
			...
			password_shares_path(1,true).should == usb_path + password_share_file_name + '_1' + $tag.to_s + '.csv'
		end													
	end
