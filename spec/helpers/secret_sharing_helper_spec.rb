...
describe SecretSharingHelper do
	...
	describe "string_to_int_string" do
		it {string_to_int_string('foo').should == '102111111'}
		it {string_to_int_string('a').should == '097'}
		it {string_to_int_string('I want $100').should == '073032119097110116032036049048048' }
		...
		it {string_to_int_string('1').should == '049'}
	...
	describe "int_string_to_string" do
		...
		it {int_string_to_string('102111111').should == 'foo'}
		it {int_string_to_string('097').should == 'a'}
		it {int_string_to_string('073032119097110116032036049048048').should == 'I want $100' }	
	...
	private
		...
		def example1_int
			''
		end
